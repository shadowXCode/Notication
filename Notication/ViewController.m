...
- (void)sendLocalNotification {
    ...
    if (@available(iOS 10.0, *)) {
        ...
        content.categoryIdentifier = @"Invite_Dely_locationCategory";
        [ViewController addInviteNotificationAction];
...
+ (void)addInviteNotificationAction {
    ...
    if (@available(iOS 10.0, *)) {
        ...
        UNNotificationCategory *notificationCategory = [UNNotificationCategory categoryWithIdentifier:@"Invite_Dely_locationCategory" actions:@[lookAction, joinAction, cancelAction] intentIdentifiers:@[] options:UNNotificationCategoryOptionCustomDismissAction];
